...
function AboutMe(){
    return(<div>
        <div className='image-container'>
            ...
            <p className='about-me'>My name is Christina Passafaro and I am a Fullstack Software Engineer that is experienced in creating and designing interactive and responsive web pages that meet customer needs and expectations.</p>
